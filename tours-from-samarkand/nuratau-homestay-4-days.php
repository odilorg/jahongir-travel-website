...
<?php $title = "Nuratau Homestay 4 days 3 night tour"; ?>
...
<div class="site wrapper-content">
		<div class="top_site_main" style="background-image:url(../images/banner/top-heading.jpg);">
			<div class="banner-wrapper container article_heading">
				...
				<?php echo $alert; ?>
				<h2 class="heading_primary">Nuaratu homestay 4 days tour </h2></div>
		</div>
					...
					<div class="top_content_single row">
						<div class="images images_single_left">
							<div class="title-single">
								<div class="title">
									<h1>Nuratau Homestay extended with Yurt Camp near Aydarkul Lake</h1>
								</div>
								<div class="tour_code">
									<strong>Code: </strong>NUR4D
								</div>
							</div>
							<div class="tour_after_title">
								...
								<div class="meta_values">
									...
									<div class="value">
										...
										<a href="#" rel="tag">Hiking, Eco Tour, Adventure</a>
									</div>
								</div>
							...
							<div class="single-tour-tabs wc-tabs-wrapper">
								...
								<div class="tab-content">
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--description panel entry-content wc-tab active" id="tab-description">
										...
										<p>This four days trip starting from Samarkand and ending in Bukhara welcomes you todiscover the
										mountain and desert landscapes of Uzbekistan along with its overwhelmingly hospitable rural people living in th e
										remote Nuratau Mountain villages.You will be staying with the mountain farmers in homestays where there is a
										great opportunity to interact with locals and learn about their culture, traditions and daily life.You will also have a
										chance to see some local sites during the day’s hike on the second day of the tour. The touris also
										complementedwith an overnight stay in a desert yurt camp, camel riding and visit to the Lake Aydarkul. In Nurata
										city, we stop to see Alexander the Greats fortress ruins, local Suzani workshop and Cahshma Mosque.</p>
										<table class="tours-tabs_table">
											<tbody>
											<tr>
												<td><strong>DEPARTURE/RETURN LOCATION</strong></td>
												<td>Samarkand or Bukhara - Nuratau Mountains- Yurt Camp- lake Aydarkul - Nurata - Bukhara or Samarkand</td>
											</tr>
											<tr>
											...
											<td><b>INCLUDED</b></td>
												<td>
													<table>
														...
														<tr>
															<td>
																<i class="fa fa-check icon-tick icon-tick--on"></i>Accommodation: 2 nights homestay, 1 night Yurt camp
															</td>
														</tr>
														<tr>
															<td>
																<i class="fa fa-check icon-tick icon-tick--on"></i>3 Breakfast, 3 Lunches, 3 Dinners
															</td>
														</tr>
														<td>
														...
														<tr>
															<td>
																<i class="fa fa-check icon-tick icon-tick--on"></i>Camel riding around the Yurt camp (30 min) and performance of local music around the fire(1 hour)
															</td>
														</tr>
														<td>
														...
														<tr>
															<td>
																<i class="fa fa-check icon-tick icon-tick--on"></i>Transport: Samarkand or Bukhara - Nuratau Mountains- Yurt Camp- lake Aydarkul - Nurata - Bukhara or Samarkand
															</td>
														</tr>
														</tbody>
													</table>
      ...
      <td>230$</td>
									...
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--itinerary_tab panel entry-content wc-tab" id="tab-itinerary_tab">
										...
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 3 Nuratau Mountains - Yurt Camp</strong></h2>
												<ul>
										         <li>8:00 Breakfast</li>
										         <li>9:00 Depart from Nuratau Mountains to Kyzyl-Kum desert (130km/2 hours)</li>
										         <li>11:30 Transfer by car to the lake Aydarkul</li>
										         <li>12:00 – 13:00 Swimming or walking around the lake</li>
										         <li>13:00 Picnic and free time around the lake</li>
										         <li>15:00 Transfer to Yurt Camp</li>
										         <li>15:30-17:00 Walk around the Yurt to see the desert landscape</li>
										         <li>17:00 – 18:00 Camel riding</li>
										         <li>18:00 Diner</li>
										         <li>20:00 Performance of local music around the fire</li>
										         <li>Overnight stay in the Yurt camp</li>
										        </ul>
											</div>
										</div>
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 4 Nuratau Mountains - Bukhara or Samarkand</strong></h2>
												<ul>
										         <li>8:00 Breakfast</li>
									...
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--location_tab panel entry-content wc-tab" id="tab-location_tab">
										...
										<div>
										<iframe src="https://www.google.com/maps/embed?pb=!1m46!1m12!1m3!1d779870.3389748946!2d65.58227404259866!3d40.22310798185648!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m31!3e0!4m5!1s0x3f4d18b454a40ec5%3A0x975a59209af77710!2s%234+Chirokchi+str.+Chirokchi+Street%2C+Samarqand%2C+Uzbekistan!3m2!1d39.649977!2d66.977987!4m5!1s0x3f52f211f535049b%3A0x543c0cb29ae8c135!2sUkhum!3m2!1d40.5467819!2d66.8037313!4m5!1s0x3f51783274ebe8cb%3A0xcc76aaa9e1d14a9!2sNurota!3m2!1d40.5631176!2d65.7015143!4m5!1s0x3f53900b3fce21f7%3A0x8b84ea6cc24298ba!2sBaymurat%2C+Uzbekistan!3m2!1d41.1350635!2d66.4241739!4m5!1s0x3f50060e65993cd5%3A0xc87beaf40e48e767!2sBukhara!3m2!1d39.7680827!2d64.4555769!5e0!3m2!1sen!2s!4v1558871386051!5m2!1sen!2s" width="800" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
    	 ...
    	 <h3 class="caption2">Nuratau Homestay extended Yurt Camp Gallery</h3>
        <div class="row">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    ...
                    <div class="caption">
								...
								<ul class="tours products wrapper-tours-slider">
										...
										<div class="item_border item-product">
											...
											<div class="wrapper_content">
												<div class="post_title"><h4>
													<a href="nuratau-homestay-3-days.php" rel="bookmark">3 days Homestay in Nuratau</a>
												</h4></div>
									...
									<li class="item-tour col-md-4 col-sm-6 product">
										<div class="item_border item-product">
											...
											<div class="wrapper_content">
												<div class="post_title"><h4>
													<a href="nuratau-homestay-2-days.php" rel="bookmark">Homestay Nuratau and Yurt Camp</a>
												</h4></div>
						...
						<input type="hidden" name="tour_name" value="Nuratau 4 days 3 nights"/>
						<input type="hidden" name="tour_code" value="NUR4D"/>												
