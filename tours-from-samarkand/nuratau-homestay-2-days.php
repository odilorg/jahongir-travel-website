...
<?php $title = "Nuratau Homestay 2 days 1 night tour"; ?>
			...
			<div class="banner-wrapper container article_heading">
				<div class="breadcrumbs-wrapper">
					<ul class="phys-breadcrumb">
						...
						<li>Nuratau Homestay 2 days</li>
					</ul>
				</div>
				<?php echo $alert; ?>
				<h2 class="heading_primary">Nuaratu homestay 2 days tour </h2></div>
		</div>
							...
							<div class="single-tour-tabs wc-tabs-wrapper">
								...
								<div class="tab-content">
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--description panel entry-content wc-tab active" id="tab-description">
										...
										<p>This two days trip to Nuratau Mountains offers you a chance to experience rural homestay with the
										mountain farmer family in the remote village of Nuratau Mountains and get to know about their daily life, traditions and customs. You will also explore the mountains, it’s flora and fauna and some local sites during short walks around the village. On the way to Bukhara we stop in an ancient city of Nurata famous for Alexander the Greats fortress ruins, local Suzani workshop and Chashma Mosque.</p>
										<table class="tours-tabs_table">
											<tbody>
											<tr>
												<td><strong>DEPARTURE/RETURN LOCATION</strong></td>
												<td>Samarkand - Nuratau Mountains - Nurata city - Bukhara or Samarkand</td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td>
													<table>
														<tbody>
														<tr>
															<td><i class="fa fa-check icon-tick icon-tick--on"></i>Accommodation: 1 nights homestay
															</td>
															<td><i class="fa fa-check icon-tick icon-tick--on"></i>Meals: 1 Breakfast, 1 Lunch, 1 Dinner
															</td>
														</tr>
														<tr>
															<td>
																<i class="fa fa-check icon-tick icon-tick--on"></i>Samarkand - Nuratau Mountains - Nurata city - Bukhara
															</td>
															<td>
      ...
      <td>125$</td>
											...
											<tr>
												...
												<td>
													<table>
														...
														<tr>
															<td>
																<a href ="tours/nuratau 2d-1n.pdf"><img src="../images/pdf-download.png" alt="pdf-file-download">Homestay in Nuratau 2 days</a>
															</td>
														</tr>
														</tbody>
													</table>
									...
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--itinerary_tab panel entry-content wc-tab" id="tab-itinerary_tab">
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 1: Samarkand - Nuratau Mountains</strong></h2>
												<ul>
										...
										<div class="interary-item">
											...
											<div class="item_content">
												<h2><strong>Day 2 Nuratau Mountains - Bukhara</strong></h2>
												<ul>
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <a class="lightbox" href="images/nuratau/horse-riding-nuratau.jpg">
                        <img src="images/nuratau/horse-riding-nuratau.jpg" alt="Horse-riding-nuratau">
                    </a>
                    <div class="caption">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <a class="lightbox" href="images/nuratau/hiking-nuratau-tour.jpg">
                        <img src="images/nuratau/hiking-nuratau-tour.jpg" alt="Hiking-in-nuratau">
                    </a>
                    <div class="caption">
                        <h3>Hiking activity in Nuratau</h3>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <a class="lightbox" href="images/nuratau/homestay-in-nuratau-mountains.jpg">
                        <img src="images/nuratau/homestay-in-nuratau-mountains.jpg" alt="At the table with the local family in Nuratau">
                    </a>
                    <div class="caption">
                        <h3>At the table with the local family in Nuratau</h3>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <a class="lightbox" href="images/nuratau/donkey-riding-asraf-village.jpg">
                        <img src="images/nuratau/donkey-riding-asraf-village.jpg" alt="Donkey Riding in Nuratau">
                    </a>
                    <div class="caption">
                        <h3>Donkey Riding in Nuratau</h3>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <a class="lightbox" href="images/nuratau/hiking-nuratau.jpg">
                        <img src="images/nuratau/hiking-nuratau.jpg" alt="Climbing Nuratau mountains">
                    </a>
                    <div class="caption">
                        <h3>Climbing Nuratau mountains</h3>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    ...
                    <div class="caption">
									...
									<li class="item-tour col-md-4 col-sm-6 product">
										<div class="item_border item-product">
											...
											<div class="wrapper_content">
												...
												<span class="post_date">3 days 2 night</span>
												<div class="description">
						...
						<input type="hidden" name="tour_name" value="Nuratau 2 days 1 night"/>
						<input type="hidden" name="tour_code" value="NUR2D"/>												
										...
										<div class="wrapper-special-tours">
											<div class="inner-special-tours">
												<a href="single-tour.php">
													<img width="430" height="305" src="images/Urgut/urgut-market-fabrics.jpg" alt="urgut-market-fabrics" title="urgut-sunday0market"></a>
